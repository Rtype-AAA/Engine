SFML -\/ Copyright (C) 2007-\/2023 Laurent Gomila -\/ \href{mailto:laurent@sfml-dev.org}{\texttt{ laurent@sfml-\/dev.\+org}}
...
\end{DoxyEnumerate}\hypertarget{md_SFML_license_autotoc_md78}{}\doxysection{External libraries used by SFML}\label{md_SFML_license_autotoc_md78}
...
\item {\itshape minimp3} is under the CC0 license 
\end{DoxyItemize}