\hypertarget{group__flac__metadata}{}\doxysection{FLAC/metadata.h\+: metadata interfaces}
\label{group__flac__metadata}\index{FLAC/metadata.h: metadata interfaces@{FLAC/metadata.h: metadata interfaces}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d5/dca/group__flac__metadata}
\end{center}
\end{figure}
>>>>>>> test_workflows
...
From a dependency standpoint, none of the encoders or decoders require the metadata module. This is so that embedded users can strip out the metadata module from lib\+FLAC to reduce the size and complexity. 