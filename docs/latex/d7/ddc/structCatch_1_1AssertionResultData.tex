...
\begin{center}
\leavevmode
\includegraphics[width=266pt]{d6/dff/structCatch_1_1AssertionResultData__coll__graph}
\end{center}
\end{figure}
...
\mbox{\hyperlink{structCatch_1_1DecomposedExpression}{Decomposed\+Expression}} const  $\ast$ {\bfseries decomposed\+Expression}
\item 
