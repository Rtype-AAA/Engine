...
//    World test;
    ...
    worldMap["test1"] = std::make_unique<World>();
    worldMap["test2"] = std::make_unique<World>();
    worldMap["test3"] = std::make_unique<World>();
    gameEngine.run(std::move(worldMap), "Ressources/");
